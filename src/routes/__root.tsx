    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <div className="mt-6">
          <Link
            to="/"
            className="inline-flex items-center justify-center rounded-md bg-[var(--cta)] px-4 py-2 text-sm font-medium text-[var(--cta-foreground)] transition-colors hover:bg-[var(--cta-hover)]"
          >
            Go home
          </Link>
        </div>
